...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/dy-yolov7-step2.yaml', help='model.yaml path')
    parser.add_argument('--weight', type=str, default='weights/dy-yolov7.pt', help='model.pt path(s)')
